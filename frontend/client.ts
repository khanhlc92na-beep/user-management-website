 ...
 */
import { createUser as api_admin_create_user_createUser } from "~backend/admin/create_user";
...
import { updateUser as api_admin_update_user_updateUser } from "~backend/admin/update_user";
...
export namespace admin {
    ...
    export class ServiceClient {
         ...
         */
        public async createUser(params: RequestType<typeof api_admin_create_user_createUser>): Promise<ResponseType<typeof api_admin_create_user_createUser>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/admin/users`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_admin_create_user_createUser>
        }

        /**
         * Deletes a user (admin only).
         */
        public async deleteUser(params: { id: string }): Promise<ResponseType<typeof api_admin_delete_user_deleteUser>> {
            // Now make the actual call to the API
         ...
         */
        public async getUser(params: { id: string }): Promise<ResponseType<typeof api_admin_get_user_getUser>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/admin/users/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
         ...
         */
        public async updateUser(params: RequestType<typeof api_admin_update_user_updateUser>): Promise<ResponseType<typeof api_admin_update_user_updateUser>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_admin_update_user_updateUser>
        }
    }
}
...
import { forgotPassword as api_user_forgot_password_forgotPassword } from "~backend/user/forgot_password";
import { googleLogin as api_user_google_login_googleLogin } from "~backend/user/google_login";
...
import { resetPassword as api_user_reset_password_resetPassword } from "~backend/user/reset_password";
import { updateProfile as api_user_update_profile_updateProfile } from "~backend/user/update_profile";
import { verifyEmail as api_user_verify_email_verifyEmail } from "~backend/user/verify_email";
...
export namespace user {
    ...
    export class ServiceClient {
         ...
         */
        public async forgotPassword(params: RequestType<typeof api_user_forgot_password_forgotPassword>): Promise<ResponseType<typeof api_user_forgot_password_forgotPassword>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/forgot-password`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_user_forgot_password_forgotPassword>
        }
         ...
         */
        public async googleLogin(params: RequestType<typeof api_user_google_login_googleLogin>): Promise<ResponseType<typeof api_user_google_login_googleLogin>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/google`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_user_google_login_googleLogin>
        }
         ...
         */
        public async resetPassword(params: RequestType<typeof api_user_reset_password_resetPassword>): Promise<ResponseType<typeof api_user_reset_password_resetPassword>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/reset-password`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_user_reset_password_resetPassword>
        }
         ...
         */
        public async verifyEmail(params: RequestType<typeof api_user_verify_email_verifyEmail>): Promise<ResponseType<typeof api_user_verify_email_verifyEmail>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/verify-email`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_user_verify_email_verifyEmail>
        }
    }
}
