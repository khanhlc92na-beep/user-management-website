...
```bash
git remote add encore encore://user-management-website-5gai
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/user-management-website-5gai/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/user-management-website-5gai/settings/integrations/github)
